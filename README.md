...
## Katalog Data Dashboard Saham

### Dokumentasi Teknis API
### Sistem Dashboard Saham
...
##### Deskripsi
Mendapatkan daftar kode emiten yang tersedia dalam database
...
| Pengguna | - |
|----------|------|
| Disediakan oleh | Data Warehouse |
...
#### Deskripsi
Mendapatkan data harga saham berdasarkan periode yang ditentukan

#### Resource URL
`/api/harga?emiten=<kode>&period=<daily/monthly/yearly>`

#### Informasi Resource
| Pengguna | - |
|----------|------|
| Disediakan oleh | YFinance API |
| Format response | JSON |
| Method | GET |
| Parameter | emiten (wajib): Kode emiten (contoh: BBCA.JK)<br>period: Periode aggregasi (daily, monthly, yearly). Default: daily |
...
#### Deskripsi
Mendapatkan data keuangan emiten yang terdaftar di IDX

#### Resource URL
`/api/idx/finance?entity_code=<kode>`

#### Informasi Resource
| Pengguna | - |
|----------|------|
| Disediakan oleh | IDX API |
| Format response | JSON |
| Method | GET |
| Parameter | entity_code (wajib): Kode entitas seperti AALI, BBCA, dll |
...
#### Deskripsi
Mendapatkan semua data IDX yang tersedia
...
#### Deskripsi
Mendapatkan semua berita yang tersedia di IQPlus
...
#### Deskripsi
Mendapatkan berita dalam rentang waktu tertentu

#### Resource URL
`/api/iqplus/recent?hours=<angka>`
...
| Format response | JSON |
| Method | GET |
| Parameter | hours (opsional): Jumlah jam terakhir (default: 24) |
...
#### Deskripsi
Mendapatkan berita yang terkait dengan kode emiten tertentu

#### Resource URL
`/api/iqplus/emiten/<emiten_code>`
...
| Format response | JSON |
| Method | GET |
| Parameter | emiten_code (wajib): Kode emiten (contoh: BBCA) |
